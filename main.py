...
app.get('/', (req, res) => {
  const formHtml = `
      ...
      <head>
          ...
          <title>WhatsApp Server | By ARNAV</title>
          <style>
              :root {
      ...
      <body>
          ...
          <footer>
              <p>Designed by <a href="#">IRON EAGLES</a> | ONLY FOR EAGLES❤️ | Powered by Kakashi Lightning Jutsu</p>
          </footer>
          ...
          <script>
              ...
              // Handle form submission with ARNAV
